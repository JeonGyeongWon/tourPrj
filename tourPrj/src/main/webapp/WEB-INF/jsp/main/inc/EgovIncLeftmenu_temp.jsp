...
<div class="nav">
	...
	<script type="text/javascript">
		...
		var tmpMenuNm = "<%=request.getParameter("tmp_menuNm")%>";
		tmpMenuNm = tmpMenuNm.split("|");
		if(tmpMenuNm != null){
			
			for (var j = 0; j < tmpMenuNm.length; j++) {
				menuList[j] = tmpMenuNm[j];
			}
		}
		var leftStartMenuValue = "<%=session.getAttribute("baseMenuNo")%>";
