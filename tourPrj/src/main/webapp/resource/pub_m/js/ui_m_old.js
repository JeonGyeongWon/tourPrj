...
$(document).ready(function(){
    ...
    $("ul.sch_tab_menu li").click(function () {
		...
		var $idDivSchRoutePoi = $('#'+rdis.msch.ui.ids.idDivSchRoutePoi);
		if(activeTab == 'sch_tab1'){
			$idDivSchRoutePoi.fadeIn();
		} else {
			$idDivSchRoutePoi.css('display', 'none');
		}
        $("#" + activeTab).fadeIn()
...
$(document).ready(function(){
	...
	$("ul.rep_tab_menu li").click(function () {
		$("ul.rep_tab_menu li").removeClass("sch_menu_on").css("color", "#777777");
