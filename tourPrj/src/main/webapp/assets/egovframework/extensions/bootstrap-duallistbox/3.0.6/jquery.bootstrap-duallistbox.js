...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="tag tag-warning">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('fa fa-angle-right').addClass('fa fa-angle-right');
        this.container.find('.removeall > i, .remove > i').removeClass('fa fa-angle-left').addClass('fa fa-angle-left');
      } else {
